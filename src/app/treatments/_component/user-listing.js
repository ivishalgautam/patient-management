...
import { deleteTreatment, updateUser, updateUserStatus } from "@/server/users";
import {
  AlertDialog,
  AlertDialogCancel,
  AlertDialogContent,
...
import { fetchTreatmentsByClinicId } from "@/server/treatment";
...
export default function UserListing() {
  ...
  const { data, isLoading, isFetching, isError, error } = useQuery({
    queryFn: () => fetchTreatmentsByClinicId(clinic.id, searchParamsStr),
    queryKey: [`treatments-${clinic.id}`, clinic, searchParamsStr],
